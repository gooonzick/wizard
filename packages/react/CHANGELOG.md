...
- 3a351f5: Binding fixes and API parity:
...
- e5b94bc: Remove the orphaned, non-functional UMD build (`dist/index.umd.cjs`). It was never referenced by package.json exports and its globals mapping (wizard-core/wizard-state/jsx-runtime as browser globals) could not work standalone. The package is now ESM-only, consistent with the other packages.
- Updated dependencies [4badcb0]
- Updated dependencies [4badcb0]
  - @gooonzick/wizard-core@1.5.1
  - @gooonzick/wizard-state@1.5.1
